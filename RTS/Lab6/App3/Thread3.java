...
public class Thread3 extends  Thread{
    ...
    CountDownLatch countDownLatch,p10;
    Thread th1;
    public Thread3(CountDownLatch p10, CountDownLatch countDownLatch,int sleepTh1,   int activity_minTh1, int activity_maxTh1, Thread1 th1) {
        this.p10=p10;
